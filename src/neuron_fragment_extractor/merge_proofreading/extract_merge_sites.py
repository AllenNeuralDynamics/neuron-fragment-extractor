...
Code that extracts merge and non-merge sites from fragments that intersect
with ground truth neuron tracings. The following outputs are extracted:
    /{brain_id}
        /{segmentation_id}
            /{neuron_id}
                * {neuron_id}.swc
                * fragments-{neuron_id}.zip
                * fragments_merged-{neuron_id}.zip
                * fragments_nonmerged-{neuron_id}.zip
                * merge_sites-{neuron_id}.csv
                * merge_sites-{neuron_id}.zip
                * nonmerge_sites-{neuron_id}.csv
                * nonmerge_sites-{neuron_id}.zip
"""
