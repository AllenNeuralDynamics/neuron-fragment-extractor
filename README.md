...
FragmentExtractor is a Python tool for generate data to train machine learning models that correct split errors in neuron segmentations. It extracts skeletal fragments from neuron segmentations at both whole-brain and local patch scales.
